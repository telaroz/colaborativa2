...
- Pegarlo en RStudio y escoger la carpeta dónde guardaremos el proyecto y todos los archivos
...
La aplicación se desplegará en una venta. Para una mejor experiencia es posible abrirla en el navegador y en un pantalla completa.
